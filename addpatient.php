...
session_start();
	...
	if(isset($_REQUEST['submit']))
	{
        ...
        mysqli_query( $con, "insert into patients (id,p_name,symptoms,p_gender,p_age,doc_id) values ('$id','$p_name','$symptoms','$p_gender','$p_age','$doc_id')");
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div id="login">
        <h3 class="text-center text-white pt-5" id="text3">Add Data</h3>
        <div class="container">
                    ...
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="p_name" id="username"  class="form-control" required/>
                            </div>
                            <div class="form-group">
                                <label for="username" class="text-info">Symptoms</label><br />
                                <input type="text" name="symptoms" id="username"  class="form-control" required/>
                            </div>
                            <div class="form-group">
                                <label for="username" class="text-info">Age</label><br />
                                <input type="text" name="p_age" id="username"  class="form-control" required/>
                            </div>
                            <div class="form-group">
                                <label for="username" class="text-info">Gender</label><br />
                                <input type="text" name="p_gender" id="username"  class="form-control" required/>
                            </div>
                            <div class="form-group">
							...
							<a href="precords.php">Go Back</a><br><br>
                        </form>
                    </div>
                </div>
            </div>
