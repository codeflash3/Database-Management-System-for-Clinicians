...
session_start();
	...
	if(isset($_REQUEST['submit']))
	{
        ...
        mysqli_query( $con, "insert into med_records (id,pid,reportdate,symptoms) values ('$id','$pid','$reportdate','$symptoms')");
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div id="login">
        <h3 class="text-center text-white pt-5" id="text3">Add Medical Data</h3>
        <div class="container">
                ...
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" method="post">
                            ...
                            <div class="form-group">
                                <label for="username" class="text-info">Report Date</label><br />
                                <input type="text" name="reportdate" id="username"  class="form-control" required/>
                            </div>
                            <div class="form-group">
							...
							<a href="mrecords.php">Go Back</a><br><br>
                        </form>
                    </div>
                </div>
            </div>
