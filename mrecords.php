...
$id = $_SESSION["user_id"];
$id = $row1["id"];
$sql= "select * from med_records where id = $id";
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <h2 style="font-weight:300;margin-top:2%;margin-bottom:1%;margin-left:1%">Medical Records</h2>
  
  <button type="button"  class="btn btn-secondary btn-lg"><a id="kal "href="addmedroc.php"><i class="fa fa-plus" id="icon"aria-hidden="true"></a></i></button>
            ...
            <tr>
              ...
              <td>
                <span class="action_btn">
                  ...
                  <a href="#"><i class="fa fa-trash-o" style="font-size:17px"></i></a>
                </span>
              </td>
            </tr>
            <?php
