...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <h2 style="font-weight:300;margin-top:2%;margin-bottom:1%;margin-left:1%">Appointments</h2>
  
  <button type="button"  class="btn btn-secondary btn-lg"><a id="kal "href="addappt.php"><i class="fa fa-plus" id="icon"aria-hidden="true"></a></i></button>
